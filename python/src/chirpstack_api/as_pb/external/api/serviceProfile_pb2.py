...
_LISTSERVICEPROFILEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='network_server_id', full_name='api.ListServiceProfileRequest.network_server_id', index=3,
